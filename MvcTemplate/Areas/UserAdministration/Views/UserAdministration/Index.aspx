<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<MvcTemplate.Areas.UserAdministration.Models.UserAdministration.IndexViewModel>" %>
    ...
    <div class="mvcMembership-allUsers">
        ...
        <ul class="mvcMembership mvcMembership-users">
            <% foreach (var user in Model.Users)
               { %>
            <li><span class="mvcMembership-username">
                <% =Html.ActionLink(user.UserName, "Details", new{ id = user.ProviderUserKey}) %></span>
                <span class="mvcMembership-email"><a href="mailto: <%= user.Email %>">
                    <%= user.Email %></a></span>
                <% if (user.IsOnline)
                   { %>
                ...
                <% if (!string.IsNullOrEmpty(user.Comment))
                   { %>
                <span class="mvcMembership-comment">
                    <%= user.Comment %></span>
                <% } %>
            </li>
            <% } %>
        ...
        <ul class="mvcMembership mvcMembership-paging">
            ...
            <% }
               ...
               { %>
            <li>
                <% =Html.ActionLink("First", "Index") %></li>
            <li>
                <% =Html.ActionLink("Previous", "Index", new { index = Model.Users.PageIndex - 1 })%></li>
            <% } %>
            <li>Page
                <% =Model.Users.PageNumber%>
                of
                <% =Model.Users.PageCount%></li>
            ...
            <% }
               ...
               { %>
            <li>
                <% =Html.ActionLink("Next", "Index", new { index = Model.Users.PageIndex + 1 })%></li>
            <li>
                <% =Html.ActionLink("Last", "Index", new { index = Model.Users.PageCount - 1 })%></li>
            <% } %>
        </ul>
        <% }
           else
