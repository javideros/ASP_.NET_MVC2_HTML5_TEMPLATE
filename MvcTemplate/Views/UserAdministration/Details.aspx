...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <link href='<% =Url.Content("~/Content/MvcMembership/MvcMembership.css") %>' rel="stylesheet"
        type="text/css" />
    <h2>
        User Details:
        <% =Html.Encode(Model.DisplayName) %>
    ...
    <div class="mvcMembership-account">
        <dl>
            <dt>User Name:</dt>
            <dd>
                <% =Html.Encode(Model.User.UserName) %></dd>
    ...
    <div class="mvcMembership-password">
        ...
        <p>
            Locked out since
            <% =Model.User.LastLockoutDate.ToString("MMMM dd, yyyy h:mm:ss tt", CultureInfo.InvariantCulture) %></p>
        ...
        <dl>
            <dt>Last Changed:</dt>
            <dd>
                <% =Model.User.LastPasswordChangedDate.ToString("MMMM dd, yyyy h:mm:ss tt", CultureInfo.InvariantCulture) %></dd>
        </dl>
        <% } %>
            ...
            <p>
                <dl>
                    ...
                    <% if (string.IsNullOrEmpty(Model.User.PasswordQuestion) || string.IsNullOrEmpty(Model.User.PasswordQuestion.Trim()))
                       { %>
                    <dd>
                        <em>No password question defined.</em></dd>
                    <% }
                       else
                       { %>
                    <dd>
                        <% =Html.Encode(Model.User.PasswordQuestion) %></dd>
                    <% } %>
                </dl>
            </p>
            <p>
